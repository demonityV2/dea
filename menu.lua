...
if not isfile("Surge.gg") then
    makefolder("Surge.gg")
 end
 
 local menu = game:GetObjects("rbxassetid://87013109227096")[1] 
 ...
 local function createWatermark()
    ...
    task.spawn(function()
        while task.wait() do
            ...
            WaterMarkLabel.Text = 'Surge.gg<font color="rgb(74, 74, 74)"></font> - #1 Script<font color="rgb(74, 74, 74)"></font> / fps: <font color="rgb(202, 25, 39)">' .. fpsValue .. '</font> / ping: <font color="rgb(202, 25, 39)">' .. ping .. '</font> / time: <font color="rgb(202, 25, 39)">' .. time .. '</font>'
        end
    end)
 ...
 local library = {
    Title = 'Surge.gg<font color="rgb(74, 74, 74)"></font> | Private',
    ...
    CloneScreenGui.Name = "Surge.gg_gui"
                    ...
                    function library:addTab(name,image)
                        ...
                        function contains(list, x)
                            for _, v in pairs(list) do
                                ...
                                writefile("Surge.gg/"..name..".cfg",game:GetService("HttpService"):JSONEncode(jig))
                        ...
                        local tbl = {}
                        for i,v in next, listfiles("Surge.gg") do table.insert(tbl,v) end
